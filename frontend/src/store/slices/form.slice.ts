...
import { IAd, AdTypes, INedvizhimost, ITransport, IUslugi } from "../../types/ad.types";
...
const formSlice = createSlice({
  ...
  reducers: {
    ...
    setNedvizhimostInfo: (state, action: PayloadAction<Partial<INedvizhimost>>) => {
...
export const { setGeneralInfo, setNedvizhimostInfo, setTransportInfo, setUslugiInfo, resetFormAction } = formSlice.actions;
